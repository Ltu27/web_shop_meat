    ...
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" class="form-control" id="" placeholder="Input fieald">
            </div>
            <div class="form-group">
                <label for="">Product sale price</label>
                <input type="text" name="sale_price" class="form-control" id="" placeholder="Input fieald">
            </div>
            <div class="form-group">
